 ...
 * Use the [CadastraPetPerdidoFragment.newInstance] factory method to
...
class CadastraPetPerdidoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CadastraPetPerdidoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CadastraPetPerdidoFragment().apply {
